...
public class WoodchipItem extends VanillaExpandedModElements.ModElement {
	@ObjectHolder("vanilla_expanded:woodchip")
	public static final Item block = null;
	public WoodchipItem(VanillaExpandedModElements instance) {
		super(instance, 21);
	}
